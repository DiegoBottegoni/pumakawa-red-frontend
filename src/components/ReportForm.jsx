...
import { MapPin, Camera, CheckCircle, Send, Loader2 } from "lucide-react";
...
const ReportForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.incidentType) {
      setStatus({ ...status, error: "Por favor, seleccioná qué está pasando con el puma." });
      return;
    }
    if (formData.incidentType === "otra" && !formData.otherIncidentType) {
      setStatus({ ...status, error: "Por favor, especificá la situación." });
      return;
    }
    if (!formData.photo && !formData.location) {
      setStatus({
        ...status,
        error: "Por favor, añadí al menos una foto o tu ubicación para poder ayudar.",
      });
      return;
    }
      ...
      <div className="rf-container">
        ...
        <form className="rf-form" onSubmit={handleSubmit}>
            ...
            {formData.incidentType === "otra" && (
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, otherIncidentType: e.target.value })
                  }
                />
              </motion.div>
            )}
          ...
          <div className="rf-section">
            ...
            <div className="rf-field">
              <label htmlFor="description" className="rf-label">
